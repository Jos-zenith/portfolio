...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'experience', 'projects', 'achievements', 'skills', 'contact'];
  ...
  const skillCategories = [
    ...
    },
    {
      title: 'Technologies',
      icon: Wrench,
      skills: ['Web Development', 'Arduino', 'AutoCAD', 'NX CAD', 'MATLAB'],
      color: 'from-orange-500 to-red-600',
    },
    {
      title: 'Project Tools',
      icon: Lightbulb,
      skills: ['Jira', 'Trello', 'MS Excel', 'Documentation'],
      color: 'from-emerald-500 to-teal-600',
    },
    {
      title: 'Soft Skills',
      ...
      <section id="home" className={`relative min-h-screen flex items-center justify-center bg-gradient-to-br ${t.gradient} pt-20`}>
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
            ...
            >
              <Phone size={18} />
              {theme === 'kiddy' ? '📞 Call Me!' : 'Contact Me'}
            </a>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold ${t.text} mb-4`}>
              {theme === 'kiddy' ? '🎯 My Cool Adventures' : 'Work Experience'}
            </h2>
